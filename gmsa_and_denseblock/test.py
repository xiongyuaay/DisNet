...
if __name__ == '__main__':
    ...
    if os.path.exists('./train_prior/model_checkpoint2.pth'):
        checkpoint = torch.load('./train_prior/model_checkpoint2.pth')
    ...
    save_image(output, os.path.join(out_path, "output32pib{}.png".format(idx)))
