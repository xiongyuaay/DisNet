...
if __name__ == '__main__':
    ...
    if os.path.exists('./train_prior/model_checkpoint16.pth'):
        checkpoint = torch.load('./train_prior/model_checkpoint16.pth')
    ...
    save_image(output, os.path.join(out_path, "19output{}.png".format(idx)))
